...
watch([email, password], (newValue, oldValue) => {
    ...
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="mt-8">
          ...
          <div class="mt-6" @keyup.enter="login">
            <div class="space-y-6">
              <div>
                ...
                <div class="mt-1">
                  <input
                    id="email" v-model="email" name="email" type="email" autocomplete="email" required="true"
              ...
              <p v-if="validation" class="flex mt-2 text-sm text-red-600">
                <ExclamationCircleIcon class="h-5 w-5 mr-1 text-red-500" aria-hidden="true" />{{ validationMessage }}
              </p>
