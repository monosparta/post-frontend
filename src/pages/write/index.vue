      ...
      <main class="auto-cols-min">
        <div class="mt-4 h-10">
          <input
            ...
            placeholder="請輸入文章標題"
            class="block w-full rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 text-lg font-light font-Inter"
          >
        </div>
        <div class="mt-4">
          <textarea
